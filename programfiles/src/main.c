...
void app_main() {
    ...
    // If you want, do other tasks here or just return to idle
    // vTaskDelete(NULL); // If you want to delete the main task to end app_main
}
>>>>>>> d5907adff4ecd23bc1d4c2c26fb7e8847e365d26
